...
class ProductToErpTransformResource extends JsonResource
{
    ...
    public function toArray($request): array
    {
        ...
        $data = [
            ...
            "descricaoCurta" => $preparedProduct->description['small']['html'] ?? $preparedProduct->description['complement']['html'],
            "dataValidade" => null,
            ...
            "descricaoComplementar" => $preparedProduct->description['complement']['html'],
            "observacoes" => null,
